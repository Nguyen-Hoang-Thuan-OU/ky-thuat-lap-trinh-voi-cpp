// Viết chương trình định nghĩa struct PhanSo gồm các thông tin:
//• Tử số kiểu int
//• Mẫu số kiểu int
//Sau đó viết các hàm:
//• Nhập và xuất thông tin 1 phân số.
//• Hàm nhận vào 2 phân số, trả về kết quả cộng, trừ nhân và chia của 2 phân số này.
//• Hàm main: khai báo phân số a, b, c thuộc kiểu PhanSo.
// Gọi hàm nhập giá trị cho 2 phân số a và b. Xuất thông tin 2 phân số này.
// Gọi hàm cộng, trừ, nhân chia. Gán kết quả cho phân số c và xuất c.
