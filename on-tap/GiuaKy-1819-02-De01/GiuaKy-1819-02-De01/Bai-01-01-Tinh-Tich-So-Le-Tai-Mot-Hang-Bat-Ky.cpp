...
void nhapMang(int a[][MAX_COT], int dong, int cot);
void inMang(int a[][MAX_COT], int dong, int cot);
int tinhTichCacSoLeTaiMotDong(int a[][MAX_COT], int cot, int dongCanTinhTich);
...
int tinhTichCacSoLeTaiMotDong(int a[][MAX_COT], int cot, int dongCanTinhTich)
{
	...
	for (int j = 0; j < cot; j++)
		if (a[dongCanTinhTich][j] % 2 != 0)
		{
			if (tichCacSoLe == 0)
				tichCacSoLe = 1;
			tichCacSoLe = tichCacSoLe * a[dongCanTinhTich][j];
		}
